  ...
  try {
    ...
    const response = await fetch("https://api.resend.com/emails", {
      ...
      body: JSON.stringify({
        ...
        html: "<h2>Nieuwe offerteaanvraag</h2><p><strong>Naam:</strong> " + naam + "</p><p><strong>E-mailadres:</strong> " + email + "</p><p><strong>Telefoonnummer:</strong> " + (telefoon || "Niet opgegeven") + "</p><p><strong>Bericht:</strong></p><p>" + bericht + "</p>"
      })
    });
...
// ../.wrangler/tmp/pages-0n50Og/functionsRoutes-0.6679756760519614.mjs
var routes = [
  {
